...
_HPU_DEEPSPEED_AVAILABLE = (
    # HPU deep speed is supported only through this pip install git+https://github.com/HabanaAI/DeepSpeed.git@1.15.0
    RequirementCache("deepspeed==0.12.4+hpu.synapse.v1.15.0")
)
        ...
        **kwargs: Any,
        ...
        if not _HPU_DEEPSPEED_AVAILABLE:
            raise MisconfigurationException(
                ...
                " Install it by running `pip install git+https://github.com/HabanaAI/DeepSpeed.git@1.15.0`."
            )
